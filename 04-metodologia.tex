...
Para medir o desempenho da solução serão aplicadas no presente trabalho: acurácia e precisão, expressas pelas equações \ref{eq:acc}, \ref{eq:precision} e \ref{eq:recall}.
